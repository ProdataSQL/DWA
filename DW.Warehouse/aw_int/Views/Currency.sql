...
SELECT  CONVERT(VARCHAR(16),HASHBYTES('MD5', [CurrencyCode]),2) AS CurrencyKey
	, ISNULL(CONVERT(CHAR(3), [CurrencyCode] COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8), '') AS CurrencyAlternateKey
	, ISNULL(CONVERT(VARCHAR(50), [CurrencyName] COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8), '') AS CurrencyName
	...
	, CONVERT(VARCHAR(512), [FileName] COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8) AS FileName
