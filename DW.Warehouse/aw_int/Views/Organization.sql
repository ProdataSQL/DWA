...
SELECT ISNULL(CONVERT(VARCHAR(16),HASHBYTES('MD5', p.OrganizationName),2),'') AS OrganizationKey
	, CONVERT(VARCHAR(16), c.ParentOrganizationKey COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8) AS ParentOrganizationKey
	, ISNULL(CONVERT(VARCHAR(10), PercentageOfOwnership COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8), 0) AS PercentageOfOwnership
	, ISNULL(CONVERT(VARCHAR(50), p.OrganizationName COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8), '') AS OrganizationName
	, ISNULL(CONVERT(VARCHAR(16), cu.CurrencyKey COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8), 0) AS CurrencyKey
	...
	,ISNULL(CONVERT(VARCHAR(36),p.LineageKey COLLATE Latin1_General_100_CI_AS_KS_WS_SC_UTF8),0)  AS  LineageKey
