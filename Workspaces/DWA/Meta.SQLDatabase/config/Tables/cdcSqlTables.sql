CREATE TABLE [config].[cdcSqlTables] (
    ...
    CONSTRAINT [PK_cdcSqlTables] PRIMARY KEY CLUSTERED ([ConfigurationID] ASC, [Database] ASC, [Table] ASC),
    CONSTRAINT [FK_cdcSqlTables_Configurations] FOREIGN KEY ([ConfigurationID]) REFERENCES [config].[Configurations] ([ConfigurationID])
);
